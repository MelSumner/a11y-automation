...
It's possible that a linting rule could be created for this potential failure. Check for `ul` and `ol` elements, check that the role is not defined differently, and ensure the correct descendants.
